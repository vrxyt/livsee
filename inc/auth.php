 ...
 *
 * NOTE: This file sets up both the $user for use later
...
if (!empty($_SESSION['authenticated']) && $user->session_authenticate($_SESSION['authenticated'], $action) === false) {	header('Location: login.php'); }
