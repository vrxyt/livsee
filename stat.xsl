...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="/">
		<html>
			<head>
				...
				<style>
				table{border-collapse:collapse;width:100%;white-space:nowrap;color:#cbcbcb;background:#720d0d;}
				.header,.header2{color:#ebebeb;background:#4e5d6c;}
				.application{color:#026597;background:#a6b3bf;}
				.live{background:#a6b3bf;color:#2b3e50;}
				.activestream{background:#4e5d6c;color:#ebebeb}
				.substreamwrap{background:#4e5d6c;color:#a6b3bf;}
				.substreamtable{color:#4e5d6c;background:#a6b3bf;}
				.client{background:#a6b3bf;color:#4e5d6c;}
				.clientpublishing{background:#026597;color:#fff;}
				a,a:visited,a:hover{color:#df691a;}				    
				</style>
			</head>
			<body>
				<xsl:apply-templates select="rtmp"/>
				<hr/>
				<font color="#cbcbcb">Generated by <a href='https://github.com/arut/nginx-rtmp-module'>
				...
				built <xsl:value-of select="/rtmp/built"/>&#160;<xsl:value-of select="/rtmp/compiler"/></font>
			</body>
		</html>
	</xsl:template>
	...
	<xsl:template match="stream">
		<tr valign="top">
			<xsl:attribute name="class">
				<xsl:choose>
					<xsl:when test="active">activestream</xsl:when>
					<xsl:otherwise>stream</xsl:otherwise>
				</xsl:choose>
			</xsl:attribute>
			<td>
				<a href="">
		...
		<tr style="display:none">
			...
			<td class="substreamwrap" colspan="16">
				<table class="substreamtable" cellspacing="1" cellpadding="5">
					<tr>
						<th>Id</th>
						<th>State</th>
						<th>Address</th>
	...
	<xsl:template match="client">
		<tr>
			<xsl:attribute name="class">
				<xsl:choose>
					<xsl:when test="publishing">clientpublishing</xsl:when>
